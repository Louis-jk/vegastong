...
const adPostGallery = [
  {
    id: 1,
    image: {
      uri: 'https://t1.daumcdn.net/cfile/tistory/23681B3F5818B02315',
    },
...
const PostScreen4 = ({navigation, route}) => {
        ...
        <Button transparent>Search</Button>
          ...
          <Content style={{padding: 20}}>
            ...
            <View style={{marginVertical: 20}}>
              <Text style={{fontSize: 20, fontWeight: 'bold'}}>#쇼핑</Text>
