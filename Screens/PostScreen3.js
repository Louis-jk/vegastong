...
const adPostGallery = [
  {
    id: 1,
    image: {
      uri: 'https://t1.daumcdn.net/liveboard/gilbut/682b7b91546a48458686c22c883174e1.JPG'
    },
  ...
  },
  {
    id: 2,
    image: {
      uri: 'https://www.srtimes.kr/news/photo/202003/57850_52108_3813.jpg'
    },
  ...
  },
  {
    id: 3,
    image: {
      uri: 'https://lh3.googleusercontent.com/proxy/P64g0JSX5qkkHbiPRApKz_CahMmWIrA6RiDjR0EFzc45To1DoKfHXHWLFON8jL2yZBavnvxz6dZkScWmJos9LbHjWXiokqbcbfeLeBX72Ak54kWUSlp1v8_XDvxmZR3UqZY'
    },
...
const PostScreen3 = ({ navigation, route }) => {
        ...
        <Button transparent>Search</Button>
          ...
          <Content style={{ padding: 20 }}>
            <View style={{ flexDirection: 'row' }}>
              ...
              >
                <Text style={{ fontSize: 15, color: '#fff' }}>카페/주점 x</Text>
              </TouchableOpacity>
              <TouchableOpacity
                activeOpacity={1}
            ...
            <View style={{ marginVertical: 20 }}>
              <Text style={{ fontSize: 20, fontWeight: 'bold' }}>#카페/주점</Text>
